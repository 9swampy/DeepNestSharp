namespace DeepNestLib.Geometry
{
  ...
  public class NoFitPolygonUtil
  {
    public static double Tolerance => GeometryUtil.Tolerance;
    ...
    private static bool OnSegment(SvgPoint svgPoint1, SvgPoint svgPoint2, SvgPoint svgPoint3)
    {
      return GeometryUtil.OnSegment(svgPoint1, svgPoint2, svgPoint3);
    }

    private static bool AlmostEqual(double a, double? b)
    {
      return GeometryUtil.AlmostEqual(a, b);
    }
    ...
    private static bool AlmostEqual(double a, double b, double tolerance)
    {
      return GeometryUtil.AlmostEqual(a, b, tolerance);
    }
    ...
    public static double? PolygonSlideDistance(INfp a, INfp b, NoFitPolygonUtil.NVector direction, bool ignoreNegative)
    {
      a = a.Slice(0);
      b = b.Slice(0);
    ...
    {
      return GeometryUtil.PointInPolygon(point, polygon);
    }
