namespace DeepNestLib
{
    ...
    public class DxfExporter : ExporterBase, IExport
    {
        ...
        protected async override Task Export(string path, IEnumerable<INfp> polygons, IEnumerable<ISheet> sheets)
        {
        ...
        private DxfFile GenerateDxfFile(IEnumerable<INfp> polygons, ISheet sheet, int i = 0)
        {
            ...
            foreach (var entity in GetOffsetDxfEntities(polygons.Where(o => o.Sheet.Id == sheet.Id), sheet, i))
            {
