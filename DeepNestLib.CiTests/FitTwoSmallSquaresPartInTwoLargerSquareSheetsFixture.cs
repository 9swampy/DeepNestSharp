...
using System.Diagnostics;
  ...
  public class FitTwoSmallSquaresPartInTwoLargerSquareSheetsFixture
  {
    ...
    public FitTwoSmallSquaresPartInTwoLargerSquareSheetsFixture()
    {
      ...
      this.nestResult = new Background(A.Fake<IProgressDisplayer>(), A.Dummy<SvgNest>(), A.Dummy<MinkowskiSum>(), A.Dummy<NestState>()).PlaceParts(new ISheet[] { firstSheet, secondSheet }, new INfp[] { firstPart, secondPart }, new SvgNestConfig(), A.Dummy<Stopwatch>());
    }
    ...
    {
      this.nestResult.Fitness.Should().BeApproximately(2589, 1);
    }
