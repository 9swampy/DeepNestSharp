namespace DeepNestLib
{
    ...
    public partial class D3
    {
        ...
        public static double[][] polygonHull(double[][] points)
        {
            ...
            for (int i = 0; i < n; ++i)
            {
                sortedPoints[i] = new HullInfoPoint { x = points[i][0], y = points[i][1], index = i };
            }
            ...
            for (int i = 0; i < n; ++i)
            {
                flippedPoints[i] = new double[] { sortedPoints[i].x, -sortedPoints[i].y };
            }
            ...
            for (int i = skipLeft ? 1 : 0; i < lowerIndexes.Length - (skipRight ? 1 : 0); ++i)
            {
